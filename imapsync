...
sub tests_email_report_message_id  
{
        ...
        'email_report_message_id: no args => ...._.._.._.._.._.._...__@imapsync.tk' ) ;
        
        my $mysync = {  } ;
        like( email_report_message_id( $mysync ),
        qr{^...._.._.._.._.._.._...__\@imapsync.tk$}xms,
        'email_report_message_id: undef => ...._.._.._.._.._.._...__@imapsync.tk' ) ;
        
        $mysync->{ timestart } = 1357902468.531 ;
        like(
        email_report_message_id( $mysync ),  
        qr{^2013_01_11_\d\d_07_48_530__\@imapsync.tk$}xms,
        'email_report_message_id: 1357902468.531 => 2013_01_11_\d\d_07_48_530__@imapsync.tk' ) ;
        ...
        'email_report_message_id: 1357902468.531 sarah haras => 2013_01_11_\d\d_07_48_530_sarah_haras@imapsync.tk' ) ;
        ...
        'email_report_message_id: 1357902468.531 sar@ah har@as => 2013_01_11_\d\d_07_48_530_sar_ah_har_as@imapsync.tk' ) ;
...
sub tests_email_report_from
{
        ...
        is( 'help@imapsync.tk', email_report_from(  ),  'email_report_from: no args => help@imapsync.tk' ) ;
        my $mysync = {  } ;
        is( 'help@imapsync.tk', email_report_from( $mysync ),  'email_report_from: undef => help@imapsync.tk' ) ;
        $mysync->{ email_report_from } = 'foo@example.com' ;
        is( 'foo@example.com', email_report_from( $mysync ),  'email_report_from: foo@example.com => foo@example.com' ) ;
...
sub tests_email_report_to
{
        ...
        is( 'unknown@imapsync.tk', email_report_to(  ),  'email_report_to: no args => help@imapsync.tk' ) ;
        my $mysync = {  } ;
        is( 'unknown@imapsync.tk', email_report_to( $mysync ),  'email_report_to: undef => help@imapsync.tk' ) ;
        $mysync->{ user2 } = 'foo@example.com' ;
        is( 'foo@example.com', email_report_to( $mysync ),  'email_report_to: foo@example.com => foo@example.com' ) ;
...
sub tests_email_report_body_base
{
        ...
        $mysync->{ user1 } = 'user1@example.com' ;
        $mysync->{ user2 } = 'user2@example.com' ;
